...
SFX = {
  laser:     new Audio('debris/sfx_laser.wav'),     // replaced: original Freesound file had unverified license
  explosion: new Audio('debris/sfx_explosion.wav')  // replaced: original Freesound file had unverified license
};
